  ...
  <div className="min-h-screen pt-32 pb-20 px-4 text-center max-w-4xl mx-auto">
    ...
    <div className="bg-white p-12 rounded-3xl shadow-xl border border-gray-100">
      <p className="text-xl text-gray-600 leading-relaxed mb-8">
        هذه الصفحة قيد التطوير لتكون بأفضل جودة تليق بعملاء EhabGM. نحن نعمل دائماً على توفير أفضل تجربة رقمية في مصر من خلال {ONLINE_DOMAIN} و {STORE_DOMAIN}.
      </p>
      <div className="space-y-6 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-right">
          ...
          <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-3">
            <Icons.Phone className="text-blue-600" size={24} />
            <span className="font-bold">+201140057253</span>
          </div>
          <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-3">
            <Icons.Mail className="text-blue-600" size={24} />
            <span className="font-bold">info@ehabgm.store</span>
          </div>
          <div className="bg-gray-50 p-4 rounded-xl flex items-center gap-3">
            <Icons.Mail className="text-blue-600" size={24} />
            <span className="font-bold">info@ehabgm.online</span>
          </div>
        </div>
      </div>
      <div className="flex justify-center gap-4">
        <a href="https://wa.me/201022679250" className="bg-blue-600 text-white px-10 py-4 rounded-xl font-bold shadow-lg hover:bg-blue-700 transition-all">تواصل واتساب</a>
      </div>
    </div>
  </div>
);
      ...
      <div className="min-h-screen flex flex-col font-cairo" dir="rtl">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/about" element={<Page title="من نحن - قصة نجاح EhabGM" />} />
        ...
        <a 
          ...
          className="fixed bottom-8 left-8 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all z-50 group flex items-center gap-2"
